...
to-report the-poor
  report turtles with [ vision <= 3 and metabolism >= 3 ]
end
...
to-report the-normal
  report count turtles - count the-poor - count the-rich
end

to-report poor-wealth
  report sum [sugar] of the-poor
end

to-report rich-wealth
  report sum [sugar] of the-rich
end

to-report normal-wealth
  report sum [sugar] of turtles - sum[sugar] of the-rich - sum[sugar] of the-poor
end

to-report avg-poor-wealth
  report poor-wealth / count the-poor
end

to-report avg-rich-wealth
  report rich-wealth / count the-rich
end

to-report avg-normal-wealth
  report normal-wealth / (count turtles - count the-poor - count the-rich)
end
...
290
390
population for different groups
NIL
NIL
0.0
10.0
...
"" ""
PENS
"the-normal" 1.0 0 -13791810 true "" "plot (count turtles - count the-poor - count the-rich)"
"the-poor" 1.0 0 -13840069 true "" "plot count the-poor"
"the-rich" 1.0 0 -2674135 true "" "plot count the-rich"
...
"" ""
PENS
"death" 1.0 0 -16777216 true "" "plot (initial-population - count turtles)/ initial-population"
...
"" ""
PENS
"the-normal" 1.0 0 -13791810 true "" "plot avg-normal-wealth"
"the-poor" 1.0 0 -13840069 true "" "plot avg-poor-wealth"
...
"" ""
PENS
"the-rich" 1.0 0 -2674135 true "" "plot avg-rich-wealth"
...
@#$#@#$#@
<experiments>
  <experiment name="death-rate" repetitions="5" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <exitCondition>not any? the-poor</exitCondition>
    <metric>count turtles</metric>
    <metric>count turtles - count the-poor - count the-rich</metric>
    <metric>count the-poor</metric>
    <metric>count the-rich</metric>
    <metric>avg-normal-wealth</metric>
    <metric>avg-poor-wealth</metric>
    <metric>avg-rich-wealth</metric>
